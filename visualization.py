...
if __name__ == "__main__":
    # ========= SETUP =========
    dataset_dir = 'D:/Deepfake/datasets/Test-Dev'  # <-- folder with images
    annotation_gt = 'D:/Deepfake/datasets/Annotations/Test-Dev_poly_cleaned.json'
    annotation_pred = 'predictions/pred_test_dev.json'  # <-- model output
    output_gt_dir = 'visualizations/gt_test_dev'
    output_pred_dir = 'visualizations/pred_test_dev'

    # ========= VISUALIZE GROUND TRUTH =========
    print("\n🎯 Visualizing ground truth masks...")
    visualize_gt(
        ann_file=annotation_gt,
    ...
    predictions = load_json(annotation_pred)
    predictions = prediction_to_boxes(predictions, dataset, mode='poly')
    ...
    visualizer.visualize_predictions(
        ...
        mask_alpha=0.5,
        text_alpha=0.5,
        use_random_color_mask=False,
        use_white_color_contour=False,
        text_color=(255, 255, 255)
    )
