...
if __name__ == '__main__':
    ...
    augment_dataset(dir_input='D:/Deepfake/Train',
                    dir_output='D:/Deepfake/Augmented_Train',
                    seq=seq)
def get_augmentation(level=1):
    if level == 1:
        return augmentation_lvl1()
    elif level == 2:
        return augmentation_lvl2()
    elif level == 3:
        return augmentation_lvl3()
    elif level == 4:
        return augmentation_lvl4()
    else:
        return None